...
import { fetchApi, baseUrl } from '../../illustrated_Estate/front-end/utils/fetchApi'

import ImageScrollbar from '../../illustrated_Estate/front-end/src/components/ImageScroller';
    ...
    <Box w='full' p='6'>
      <Flex paddingTop='2' alignItems='center'>
        ...
        <Text fontWeight='bold' fontSize='lg'>
          Potatoes {price} {rentFrequency && `/${rentFrequency}`}
        </Text>
        <Spacer />
